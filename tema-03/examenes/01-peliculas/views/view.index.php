        ...
        <tbody>
          ...
          <?php foreach ($peliculas as $pelicula): ?>
            ...
            <tr>
              ...
              <td><?= $generos[$pelicula['generos']] ?></td>
              <td><?= $pelicula['año'] ?></td>
              
              <!-- Muestro los botones de acción -->
              <td>
                <a href="eliminar.php?=<?= $pelicula['id'] ?>" Title="Eliminar"><i class="bi bi-trash-fill"></i></a>
                <a href="modificar.php?=<?= $pelicula['id'] ?>" Title="Modificar"><i class="bi bi-pencil-square"></i></a>
