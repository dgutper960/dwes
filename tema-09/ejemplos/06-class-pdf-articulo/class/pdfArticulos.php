...
class PdfArticulos extends FPDF{ //heredamos todas las proiedades y métodos de FPDF
    ...
    public function Cabecera(){
        ...
        $this->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', 'Descripción'),'B', 0, 'L', true);
        $this->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', 'Fabricante'),'B', 0, 'L', true);
        $this->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', 'Categoría'),'B', 0, 'L', true);
        $this->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', 'Etiquetas'),'B', 0, 'L', true);
        $this->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', 'Precio'),'B', 1, 'R', true);
