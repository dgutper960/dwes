...
<head>
  ...
  <title>Editar Película - CRUD Tabla Películas</title>
</head>
  ...
  <div class="container">
    ...
    <form action="update.php?indice=<?= $indice ?>" method="POST">
      ...
      <div class="mb3">
        ...
        <input name="id" type="number" class="form-control" value="<?= $pelicula->getId() ?>" readonly>
      </div>

      <!-- Campo título -->
      <div class="mb3">
        <label class="form-label">Título</label>
        <input type="text" name="titulo" class="form-control"  value="<?= $pelicula->getTitulo() ?>" required>
      </div>
      ...
      <div class="mb3">
        ...
        <input name="director" type="text" class="form-control" value="<?= $pelicula->getDirector() ?>" required>
      </div>

      <!-- Campo Año -->
      <div class="mb3">
        <label class="form-label">Año</label>
        <input name="year" type="number" class="form-control" value="<?= $pelicula->getYear() ?>" required>
      </div>
