    ...
    <div class="card">
        ...
        <div class="card-body">
           <!-- Formulario  -->
            ...
            <form action=https://educacionadistancia.juntadeandalucia.es/centros/cadiz/pluginfile.php/409401/mod_assign/introattachment/0/{{route('clientes.store')}} method="POST">
                @csrf
