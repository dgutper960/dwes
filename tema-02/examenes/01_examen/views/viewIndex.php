    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="valor" class="form-control" placeholder="" aria-describedby="helpId">
                <small id="helpId" class="text-muted">Introduzca un valor decimal</small>
            </div>
            ...
            <div class="btn-group" role="group" >
                ...
                <button type="submit" class="btn btn-danger" formaction="hexad.php">Hexadecimal</button>
            </div>
