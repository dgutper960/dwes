...
class Clientes extends Controller
{
    ...
    public function render($param = [])
    {
        ...
        # La variable de sesión 'id' va a determinar si el usuario está autentificado
        if (!isset($_SESSION['id'])) {
            $_SESSION['mensaje'] = 'Inicio de sesión requerido para este recurso';

            //Redirección a login
            header('location:' . URL . 'login'); // controlador revisado y correcto
        } else {
            // El usuario autenticado accede al resto de la función
    ...
    public function nuevo($param = [])
    {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            // en caso de ser autenticado accede al método
