    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link <?= (in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['new']) || in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['new'])) ? 'active' : 'disabled' ?>"
                        aria-current="page" href="<?= URL ?>cuentas/nuevo">Nuevo</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link <?= in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['order']) ? 'active' : 'disabled' ?> dropdown-toggle"
