                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= URL ?>register/validate">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" <?= (isset($this->errores['email'])) ? 'is-invalid' : null ?> name="name" 
                                        value="<?= $this->name; ?>" required autocomplete="name" autofocus>
