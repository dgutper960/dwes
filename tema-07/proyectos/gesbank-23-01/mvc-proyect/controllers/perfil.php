<?php
    ...
    class Perfil Extends Controller {
        ...
        public function render() {
            ...
            $this->view->title = 'Eliminar Perfil Usuario - Gestión de Alumnos - MVC';
        ...
        public function edit() {
            ...
            $this->view->title = 'Modificar Perfil Usuario -GEstion Alumnos - FP';
        ...
        public function valpass() {
            ...
            # Saneamos el formulario
            $password_form = filter_var($_POST['password_actual'] ??= null,FILTER_SANITIZE_SPECIAL_CHARS); //-> password_actual = name del formulario en el view
