...
try { 
    ...
    $mail->Username = 'gutperda.dev@gmail.com';
    $mail->Password = 'sudg zabf iwsn suvj';
    ...
    //Cabecera del emial
    $destinatario = 'gutperda.dev@gmail.com';
    $remitente    = 'gutperda.dev@gmail.com';
    ...
    $mail->setFrom($remitente, 'David');
    $mail->addAddress($destinatario, 'Pedro');
    $mail->addReplyTo($remitente, 'DAvid');
