 ...
 * -> base de datos fp
 * 
 * -> Obtenemos un array de objetos de la clase Alumno
 * 
 */
  ...
  */
  ...
  $alumno = $result->fetch_object(); // retorna solo el primer alumno, 
  var_dump($alumno);
  /** 
   * Para mostrar los campos de todos los alumnos lo metemos en un bucle
   */
