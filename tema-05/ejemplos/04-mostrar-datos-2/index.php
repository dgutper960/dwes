 ...
 * -> base de datos fp
 * 
 * -> Obtenemos un array indexado y otro asociativo
 * 
 */
  ...
  */
  ...
  $alumnos = $result->fetch_all(MYSQLI_BOTH); // constante que indica la forma en la que extrae los datos (ARRAY INDEXADO Y ASOCIATIVO)
  // -> Retorna un array asociativo donde el indice es el nombre de la columna
  // -> Retorna un array indexado que corresponde con el orden que ocupa la columna en la tabla
