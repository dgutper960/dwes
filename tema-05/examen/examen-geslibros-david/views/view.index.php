                ...
                <tbody>
                    ...
                    <?php foreach($libros as $libro): ?>
                        <tr>
                            ...
                            <!-- Columna de acciones -->
                            <td>
                                <a href="" title="Eliminar.php?id=<?=$libro->id?>" ><i class="bi bi-trash-fill" onclick="return confirm('Confimar elimación del libro')"></i></a>
                                <a href="" title="Editar.php?id=<?=$libro->id?>"><i class="bi bi-pencil-fill"></i></a>
                                <a href="" title="Mostrar.php?id=<?=$libro->id?>"><i class="bi bi-eye-fill"></i></a>
                            </td>
                        </tr>
                    <?php endforeach;?>   
                </tbody>
