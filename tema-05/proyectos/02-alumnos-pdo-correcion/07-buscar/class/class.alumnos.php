...
class Alumnos extends Conexion
{
    ...
    ORDER BY id";
        ...
        # Ejecuto
        $pdostsmt->execute(); //-> en este momento es de la clase pdostsmt (pdo no tiene result)

        # Devuelvo objeto clase pdostsmt (pdo no tiene result)
        return $pdostsmt;
    ...
    public function read_alumno($id)
    {
        try {
            ...
            return $data; //objeto de la clase Alumno cuyas propiedades coinciden con las columnas de la BBDD
        } catch (Exception $e) {
            include('views/partials/errorDB.php');
            exit();
        }
...
FROM
   ...
   cursos.nombreCorto
        ...
        # Ejecuto
        $pdostsmt->execute();
        //-> en este momento es de la clase pdostsmt (pdo no tiene result)
