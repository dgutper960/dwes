<?php
    ...
    */
    ...
    # Validación (por ahora no se hace)

    # Insertar registro
    $fp = new Alumnos();
    $fp->insert_alumno($alumno); // se espera un objeto de la clase Alumno

    // No debo cargar la vista view.index.php
    // Tengo que cargar el controlador index.php
    // header('location: index.php'); -> lO TENGO EN EL CONTROLADOR
    // PARA HACER UNA NOTIFICACIÓN NECESITAMOS UN CONTROL DE SESIONES
?>